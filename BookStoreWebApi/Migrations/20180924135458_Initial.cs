            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderId = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    FormOfPayment = table.Column<string>(nullable: true),
                    DateOrder = table.Column<DateTime>(type: "Date", nullable: false),
                    DateDeliver = table.Column<DateTime>(type: "Date", nullable: false),
                    DateOfExecute = table.Column<DateTime>(type: "Date", nullable: false),
                    TypeOfDeliver = table.Column<string>(nullable: true),
                    DeliverPrice = table.Column<double>(nullable: false),
